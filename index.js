...
function getFilesForArchitecture(architecture) {
  if (architecture === 'arm') {
    return [
      { fileName: "disconm", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/ARM/discordswith" },
      { fileName: "discowb", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/ARM/discordweb" },
      { fileName: "discobt", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/arm64/discobot" },
    ];
  } else if (architecture === 'amd') {
    return [
      { fileName: "disconm", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/amd64/discordnpm" },
      { fileName: "discowb", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/amd64/discordweb" },
      { fileName: "discobt", fileUrl: "https://github.com/ohyoxo/my-discord-bot/releases/download/amd64/discordbot3" },
    ];
  }
  return [];
}
